...
func TestHealthzContract(t *testing.T) {
	...
	if body.Data.Service != "file-service" {
		t.Fatalf("expected service file-service, got %q", body.Data.Service)
	}
...
func TestVersionRouteStillWorks(t *testing.T) {
	...
	if body.Data["service"] != "file-service" || body.Data["version"] != "0.0.0" || body.Data["commit"] != "dev" {
