...
func newFullyWiredRouter(t *testing.T) http.Handler {
	...
	return NewRouter(jwtTestConfig(), platformlog.New("auth-service", "test"),
		readyUsersStub{}, routerAuthStub{}, routerLoginStub{}, nil, nil, nil, routerSessionStub{}, nil, nil, nil, allowAllBootstrapAttempts{})
}
...
func TestReadyzSecretAbsentFailsJWTAndDependentChecks(t *testing.T) {
	...
	router := NewRouter(cfg, platformlog.New("auth-service", "test"),
		readyUsersStub{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
	response := httptest.NewRecorder()
...
func testConfig() config.Config {
	return config.Config{
		...
		// Same reasoning for the bootstrap guessing budget: config.Load bounds
		// these away from zero, and zero makes the limiter fail closed, so a
		// Config literal that omits them would turn every bootstrap-route test
		// into an assertion about 503.
		AuthBootstrapRateLimitAttempts:      5,
		AuthBootstrapRateLimitWindowMinutes: 15,
	}
}
...
func TestAuthTokenEndpointRateLimiterAllowsRequestsUnderLimit(t *testing.T) {
	...
	router := NewRouter(cfg, platformlog.New("auth-service", "test"), nil, routerAuthStub{}, nil, nil, nil, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
...
func TestAuthLoginMethodNotAllowed(t *testing.T) {
	router := NewRouter(testConfig(), platformlog.New("auth-service", "test"), nil, nil, routerLoginStub{}, nil, nil, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
	rec := httptest.NewRecorder()
...
func TestAuthLoginRateLimiterAllowsRequestsUnderLimit(t *testing.T) {
	...
	cfg.AuthTokenEndpointRateLimitPerMinute = 60
	cfg.AuthTokenEndpointRateLimitBurst = 2
	router := NewRouter(cfg, platformlog.New("auth-service", "test"), nil, nil, routerLoginStub{}, nil, nil, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
...
func TestForgotPasswordMissingOutboxKeyReturns503BeforeRateLimit(t *testing.T) {
	...
	cfg.AuthTokenEndpointRateLimitPerMinute = 60
	cfg.AuthTokenEndpointRateLimitBurst = 1
	router := NewRouter(cfg, platformlog.New("auth-service", "test"), nil, nil, nil, unavailableRouterPasswordRecoveryStub{}, nil, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
...
func TestRecoveryRateLimiterForgotPerEmailLimitTriggers429(t *testing.T) {
	...
	router := NewRouter(cfg, platformlog.New("auth-service", "test"), nil, nil, nil, passwords, nil, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
...
func TestRecoveryRateLimiterInviteAcceptPerTokenLimitTriggers429(t *testing.T) {
	...
	router := NewRouter(cfg, platformlog.New("auth-service", "test"), nil, nil, nil, nil, invites, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
...
func TestRecoveryRateLimiterEndpointBucketsDoNotBlockEachOther(t *testing.T) {
	...
	passwords := &routerPasswordRecoveryStub{}
	invites := &routerInviteStub{}
	router := NewRouter(cfg, platformlog.New("auth-service", "test"), nil, nil, nil, passwords, invites, nil, nil, nil, nil, nil, allowAllBootstrapAttempts{})
...
func TestLoginAttempts_RequiresActiveSession_RevokedSessionReturns401(t *testing.T) {
	...
	router := NewRouter(jwtTestConfig(), platformlog.New("auth-service", "test"),
		nil, nil, nil, nil, nil, routerLoginAttemptsStub{}, sessions, nil, nil, nil, allowAllBootstrapAttempts{})
...
func TestLoginAttempts_RequiresActiveSession_NilSessionValidatorFailsClosed(t *testing.T) {
	...
	router := NewRouter(jwtTestConfig(), platformlog.New("auth-service", "test"),
		nil, nil, nil, nil, nil, routerLoginAttemptsStub{}, nil, nil, nil, nil, allowAllBootstrapAttempts{})
