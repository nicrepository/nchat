-- 000017_attachment_preview_content_type.up.sql
...
-- JPEG raster — the whole RF-31 pipeline and 000016's multi-page extension
...
--
-- A page row (000016) and a sheet row differ only in what their bytes mean —
