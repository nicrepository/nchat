-- 000015_attachment_preview_pages.down.sql
-- Reverses 000015: drops the per-page table and the page-count column.
--
...
-- again — page 1, exactly as it did before 000015 — because the client reads
