...
CREATE INDEX idx_user_devices_user_revoked ON user_devices (user_id, revoked_at);
...
CREATE INDEX idx_user_sessions_id_revoked   ON user_sessions (id, revoked_at);
...
INSERT INTO auth_policy_settings DEFAULT VALUES;
