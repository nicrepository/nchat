...
5. Depois que o workflow `Governance` rodar ao menos uma vez, habilitar **Require status checks to pass before merging**.
6. Selecionar o status check `Governance` quando ele estiver disponivel.
